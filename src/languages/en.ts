...
const translations = {
    ...
    workflowsPage: {
        ...
        approvalLimitDescription: 'Reports over this amount will be forwarded to a different approver.',
    ...
    workflowsForwardLimitToPage: {
        title: 'Approver',
        header: '(Optional) Want to add an approval limit?',
        subtitle: ({approverDisplayName}: WorkflowsForwardLimitToPageSubtitleParams) => `Add another approver when <strong>${approverDisplayName}</strong> is approver and report exceeds the amount below:`,
        invalidAmount: 'Please enter a valid amount',
        reportAmount: 'Report amount',
        invalidApprover: 'Please select an approver',
    },
    reportFraudPage: {
